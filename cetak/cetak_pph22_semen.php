...
$pdf->SetTitle('cetak pph22 atas penjualan semen dalam negeri.pdf');
...
$pdf->Ln(4);
$pdf->Cell(190, 10,  'ATAS PENJUALAN SEMEN DALAM NEGERI', 0, 0, 'C');
...
// Simpan dokumen PDF
$pdf->Output('cetak pph22 atas penjualan semen dalam negeri.pdf', 'I');
