...
$pdf->SetTitle('cetak pph22 atas penjualan barang kehutanan.pdf');
...
$pdf->Ln(4);
$pdf->Cell(190, 10,  'ATAS PEMBELIAN BAHAN-BAHAN SEKTOR PERHUTANAN, ', 0, 0, 'C');
$pdf->Ln(9);
$pdf->Cell(190, 10,  'ATAS PEPERKEBUNAN, PERTANIAN, DAN PERIKANAN ', 0, 0, 'C');
...
// Simpan dokumen PDF
$pdf->Output('cetak pph22 atas penjualan Barang kehutanan.pdf', 'I');
