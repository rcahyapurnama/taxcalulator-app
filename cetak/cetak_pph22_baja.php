...
$pdf->SetTitle('cetak pph22 atas penjualan baja.pdf');
...
$pdf->Ln(4);
$pdf->Cell(190, 10,  'ATAS PENJUALAN BAJA DALAM NEGERI', 0, 0, 'C');
...
// Simpan dokumen PDF
$pdf->Output('cetak pph22 atas penjualan baja.pdf', 'I');
