...
$pdf->SetTitle('cetak pph22 atas penjualan barang kepada bumn.pdf');
...
$pdf->Ln(4);
$pdf->Cell(190, 10,  'ATAS PENJUALAN BARANG KEPADA BUMN', 0, 0, 'C');
...
// Simpan dokumen PDF
$pdf->Output('cetak pph22 atas penjualan Barang kepada BUMN.pdf', 'I');
