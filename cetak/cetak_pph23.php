...
$pdf->Cell(10, 10, '', 0, 1);
$pdf->Cell(190, 0, 'RINCIAN PERHITUNGAN PAJAK PENGHASILAN PASAL 23 ', 0, 0, 'C');
$pdf->Ln(4);
$pdf->Cell(190, 10,  $titleText, 0, 0, 'C');
...
$pdf->Cell(190, 10, 'Data Pajak Penghasilan Pasal 23', 'LTR', 0, 'L', true);
...
$pdf->Ln();
$pdf->Cell(70, 9, 'Tarif Pajak Penghasilan Pasal 23  ', 'LR');
$pdf->Cell(30, 9, $tarif_pph, 0, 0, 'R');
$pdf->Cell(90, 9, iconv('UTF-8', 'ISO-8859-9', ""), 'LR', 0, 'R');
$pdf->Ln();
$pdf->Cell(70, 9, 'Nilai Pajak Penghasilan Pasal 23 ', 'LBR');
$pdf->Cell(30, 9, '', 'B');
