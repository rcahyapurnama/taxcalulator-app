<?php
$pageTitle = "PPH 22 - Atas Penjualan Kertas";
include("navbar.php") ?>
    ...
    <div class="row text-center p-4 mt-5 ">
        <div class="col judul">
            <h3> KALKULATOR PAJAK PENGHASILAN PASAL 22
                ...
                <P> ATAS PENJUALAN KERTAS DALAM NEGERI</p>
...
<div class="container" id="pph22">
    <form method="post" action="cetak/cetak_pph22-kertas.php" target="_blank">
                ...
                <div class="card" id="pph22card2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-5 ms-auto">
                                <input type="text" class="form-control border border-secondary shadow " id="tarif_pph" name="tarif_pph" value="0.10%" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
