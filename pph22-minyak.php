<?php
$pageTitle = "PPH 22 - Atas Penjualan Minyak Tanah / Gas LPG, dan Pelumas";
include("navbar.php") ?>
...
<div class="container" id="pph22">
    <form method="post" action="cetak/cetak_pph22_minyak.php" target="_blank">
                ...
                <div class="card" id="pph22card2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-5 ms-auto">
                                <input type="text" class="form-control border border-secondary shadow " id="tarif_pph" name="tarif_pph" value="0.30%" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
