...
function hitungBPJS() {
  ...
  if (jkkCrc.includes("Rp") || jkmCrc.includes("Rp") || bpjsCrc.includes("Rp")) {
    jkk = parseFloat(jkkCrc.split(".").join("").split("Rp").join("")); // Hapus "Rp" jika ada
    jkm = parseFloat(jkmCrc.split(".").join("").split("Rp").join("")); // Hapus "Rp" jika ada
    bpjs = parseFloat(bpjsCrc.split(".").join("").split("Rp").join("")); // Hapus "Rp" jika ada
  } else {
...
function hitungJumlahjkkjkm() {
  ...
  var hasiljkk = parseFloat(hasiljkkCrc.split(".").join("").split("Rp").join(""));
  var hasiljkmCrc = document.getElementById('hasiljkm').value;
  var hasiljkm = parseFloat(hasiljkmCrc.split(".").join("").split("Rp").join(""));
  ...
  if (hasiljkk && hasiljkm && hasilbpjs) {
    var hitungjkkjkm = hasiljkk + hasiljkm
    var jumlahBPJS = hasilbpjs;
...
function hitungpengurangan() {
  ...
  if (jhtCrc.includes("Rp") || jpCrc.includes("Rp")) {
    var jht = parseFloat(jhtCrc.split('Rp').join('').split(".").join("")); // Hapus "Rp" jika ada
    var jp = parseFloat(jpCrc.split('Rp').join('').split(".").join("")); // Hapus "Rp" jika ada
